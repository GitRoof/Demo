...
// Google Maps
function initialize() {
    var myLatlng = new google.maps.LatLng(40.7033121,-73.979681,10); // here you can specify your location
    var styles = [{"featureType":"landscape","stylers":[{"saturation":-100},{"lightness":65},
        ...
        "stylers":[{"visibility":"on"},{"lightness":-25},{"saturation":-100}]},{"featureType":"water","elementType":"geometry","stylers":[{"hue":"#ffff00"},{"lightness":-25},{"saturation":-97}]}]
